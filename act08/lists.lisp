...
;; Test functions
(print "This is an accurate value for the factorial of 100 -- 100! --")
(print (factorial 100)) ;<-- This is accurate
(terpri)
...
(print (doublen 5))
(terpri)
(print "Repeat transformation: (doubled 5) applied 3 times")
...
(print "Doubling all elements of a list")
(print (double-list-elements list1))
(print (double-list-elements list2))
(terpri)
;
;find-even
(print "Return the leftmost even member")
(print (find-even list1))
(print (find-even list2))
(terpri)
;
;remove-even
(print "Remove all members of L that is an even number")
