...
##################################
# Quick Sort algorith sorts in in O(n * lg(n)) time
...
ending = Process.clock_gettime(Process::CLOCK_MONOTONIC)
timeQ3 = ending - starting


puts "\n"
print "              Time to sort in seconds       Time to sort in seconds              Time to search an element in seconds\n"
print "List          Recursive QuickSort           Recursive MergeSort                  Recursive Binary Search\n"
print "********      ************************      ************************             **************************************\n"
puts  "List 1        #{timeQ1.round(8)} seconds.           #{timeQ2.round(8)} seconds.                 #{resbi.nil? ? " Could not find #{to_search} in " : " Found #{list1[resbi]} at index #{resbi} in "}#{timeQ3.round(8)} seconds."
puts "\n"
